...
public class UT_CheckValidation_AddProduct {
	String dataPath = "./src/main/java/DataTest/AddProduct.xls";
	private String ad = "[Add]";
	Base_Definition bs = new Base_Definition();
	UT_Product pr = new UT_Product();

	@Test
	public void TestProductNullAll() throws InterruptedException, IOException{
		pr.AddProductNullAllFields();
		bs.captureScreenShoot(ad, "Product_null");
		bs.close();
	}
	...
	public void TestProductCode(String prCode, String serviceName,
		...
		try {
			// bs.load();
			pr.AddNewProduct(prCode, serviceName, postFlag, prDisplay,
	...
	public Object[][] testDataDisplayOder() {
		Object[][] arrayObject = ReadData.getExcelData(dataPath, "displayOrder");
		return arrayObject;
	}
	...
	public void TestTagSeo(String prCode, String serviceName,
			String postFlag, String prDisplay, String prAttribute,
			String displayOrder, String newDisplay, String tagSEO,
			String delivInfo, String displayNote, String abSvar,
			String productEdit, String serviceNameEdit,
