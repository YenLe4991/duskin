...
public class UT_CheckValidation_EditBanner {
	String dataPath = "./src/main/java/DataTest/EditBanner.xls";
	...
	public void TestBannerName(String name, String type, String bannerFilePC,
		...
		try {
			// bs.load();
			bn.EditBanner(name, type, bannerFilePC, AltText, bannerFileSP,
